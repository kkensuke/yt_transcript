...
REPOSITORY = "kkensuke/yttext"
FORMULA_CLASS = "Yttext"
WEB_EXTRA = "web"
TARGET_PYTHON = "3.14"
...
def render_formula(*, version: str, source_sha256: str) -> str:
    ...
    lines = [
        "# This file is generated by kkensuke/yttext. Do not edit it manually.",
    ...
    lines.extend(
        [
            ...
            "",
            "  test do",
            '    assert_match version.to_s, shell_output("#{bin}/yttext --version")',
            '    assert_match "yttext web", shell_output("#{bin}/yttext web --help")',
            "",
            "    port = free_port",
            "    pid = nil",
            '    env = { "PORT" => port.to_s, "YTTEXT_OPEN_BROWSER" => "0" }',
            '    pid = spawn env, bin/"yttext", "web"',
            "    output = shell_output(",
